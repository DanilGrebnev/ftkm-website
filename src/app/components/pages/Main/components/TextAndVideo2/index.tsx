    ...
    return (
        <Grid className={`Text-and-video-2 ${style.TextAndVideo2}`}>
            ...
            <p>
                ...
                <strong> "Исследование процессов кристаллизации сталей и сплавов"</strong> позволит
                получить тебе интересную и высокооплачиваемую специальность, востребованную на рынке
